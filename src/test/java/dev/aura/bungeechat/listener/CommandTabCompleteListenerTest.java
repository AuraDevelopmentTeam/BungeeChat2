...
@PrepareForTest(PluginManager.class)
public class CommandTabCompleteListenerTest {
  ...
  public void multipleArgsTest() {
    final TabCompleteEvent event1 = generateTabCompleteEvent("/player1 test more args");
    final TabCompleteEvent event2 = generateTabCompleteEvent("/player1 test2   more  args");
