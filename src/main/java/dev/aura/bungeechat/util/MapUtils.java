...
public class MapUtils {
    /**
     * A variant of {@link Collectors#toMap(Function, Function)} for immutable
     * maps.
     * <p>
     * Note this variant throws {@link IllegalArgumentException} upon duplicate
     * keys, rather than {@link IllegalStateException}
     * </p>
     * 
     * @param <T>
     *            type of the input elements
     * @param <K>
     *            output type of the key mapping function
     * @param <V>
     *            output type of the value mapping function
     * @param keyMapper
