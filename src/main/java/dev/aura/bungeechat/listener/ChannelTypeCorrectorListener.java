...
public class ChannelTypeCorrectorListener implements Listener {
    ...
    public void onPlayerChat(ChatEvent e) {
        ...
        if ((c.equals(ChannelType.GLOBAL) && !BungeecordModuleManager.isModuleActive(BungeecordModuleManager.GLOBAL_CHAT_MODULE)) ||
                (c.equals(ChannelType.STAFF) && !BungeecordModuleManager.isModuleActive(BungeecordModuleManager.STAFF_CHAT_MODULE))) {
