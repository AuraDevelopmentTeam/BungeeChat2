...
/**
 * This interface is used to get prefixes and suffixes for users from Permission
 * plugins.
 */
public interface BungeeChatHook extends Comparable<BungeeChatHook> {
    ...
    /**
     * Retrieves the priority of this hook. Higher priority means the hook is
     * checked earlier.
     * 
