...
public class BungeeChatContext {
	...
	public static final Predicate<BungeeChatContext> HAS_NO_PLAYER = context -> !context.hasPlayer();
	public static final Predicate<BungeeChatContext> HAS_NO_SENDER = context -> !context.hasSender();
	public static final Predicate<BungeeChatContext> HAS_NO_TARGET = context -> !context.hasTarget();
